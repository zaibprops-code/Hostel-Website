...
/**
 * Dynamically-generated Open Graph / social share card. Renders to a
 * 1200×630 image so every link to the site — WhatsApp, Instagram, Facebook,
 * X, Google — previews as a branded, on-brand card rather than a bare URL.
 */
export const alt =
  "Riwaq Boys Hostel — student accommodation in E-11/2, Islamabad";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div style={{ fontSize: "40px", color: "#e7d9a8", fontWeight: 600 }}>
            Student accommodation · E-11/2, Islamabad
          </div>
        </div>
