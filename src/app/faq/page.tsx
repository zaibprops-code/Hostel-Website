...
export const metadata: Metadata = pageMeta({
  title: "FAQ",
  description:
    "Answers to the questions people ask before moving into Riwaq Boys Hostel, E-11/2 Islamabad — WiFi, electricity, food, deposits, security, documents, universities and check-in.",
  path: "/faq",
});
