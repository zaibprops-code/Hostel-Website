        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="reveal">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-ivory/80">
              ...
              is secure, spotless and thoughtfully run accommodation in{" "}
              {primaryBranch.area}, {site.address.city} — for students and young
              professionals. Premium comfort, a genuine community, and a price
              that makes sense.
            </p>
